...
public class MedicalRecordsController extends BaseController
{
     ...
     * 查询就诊记录列表
     */
//    @PreAuthorize("@ss.hasPermi('hms:records:list')")
    @GetMapping("/list")
     ...
     * 导出就诊记录列表
     */
    @PreAuthorize("@ss.hasPermi('hms:records:export')")
     ...
     * 获取就诊记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('hms:records:query')")
     ...
     * 新增就诊记录
     */
    @PreAuthorize("@ss.hasPermi('hms:records:add')")
     ...
     * 修改就诊记录
     */
    @PreAuthorize("@ss.hasPermi('hms:records:edit')")
     ...
     * 删除就诊记录
     */
    @PreAuthorize("@ss.hasPermi('hms:records:remove')")
